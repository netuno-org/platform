        ...
        for (Values user : Config.getDBBuilder(getProteu()).selectUserSearch("")) {
            list.add(
                    new Values()
                            ...
                            .set("mail", user.getString("mail"))
                            .set("user", user.getString("user"))
                            .set("group", user.getString("group_name"))
                            .set("active", user.getString("active"))
            );
        }
