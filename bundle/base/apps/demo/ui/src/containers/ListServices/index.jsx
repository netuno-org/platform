      ...
      <div>
        <div className="panel panel-default">
          ...
          <div className="panel-body">
            <p><Title level={5}><QuestionOutlined /> {intl.formatMessage({ id: `${messages}.introduction.how-to-start.title` })}</Title></p>
            <div dangerouslySetInnerHTML={{ __html: intl.formatMessage({ id: `${messages}.introduction.how-to-start.content` }) }} />
            <p><Title level={5}><HomeOutlined /> {intl.formatMessage({ id: `${messages}.introduction.from-the-root.title` })}</Title></p>
